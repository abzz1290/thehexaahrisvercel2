...
const CreatePasswordCover = () => {

    document.title = "Create Password | The Hexaa - HR Dashboard";
                ...
                <div className="!px-10 !py-12 card-body">
                    ...
                    <form autoComplete="off" action="/">
                        <div className="mb-3">
                            ...
                            <input type="password" className="form-input dark:bg-zink-600/50 border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" required placeholder="Password" id="passwordInput" />
                        </div>
                        <div className="mb-3">
