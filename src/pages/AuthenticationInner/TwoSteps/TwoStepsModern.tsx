...
const TwoStepsModern = () => {
    ...
    document.title = "Two Steps | The Hexaa - HR Dashboard";
                    ...
                    <div className="flex flex-col w-full h-full">
                        ...
                        <div className="my-auto">
                            <div className="mt-8 text-center">
                                ...
                                <p className="mb-8 text-slate-500 dark:text-zink-200">Please enter the <b className="font-medium">4</b> digit code sent to <b className="font-medium">tailwick@thehexaa.com</b></p>
                            </div>
                        ...
                        <div className="mt-5">
                            <p className="mb-0 text-center text-15 text-slate-500 dark:text-zink-200">©
                                {new Date().getFullYear()} Tailwick. Crafted with <i className="text-red-500 ri-heart-fill"></i> by <a href="http://thehexaa.in" className="underline transition-all duration-200 ease-linear text-slate-800 dark:text-zink-50 hover:text-custom-500 dark:hover:text-custom-500">thehexaa</a>
                            </p>
                        </div>
                    </div>
                </div>
