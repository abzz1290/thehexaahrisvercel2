                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <div className="mt-8 text-center">
                            ...
                            <p className="text-slate-500 dark:text-zink-200">Get your free The Hexaa account now</p>
                        </div>
                        ...
                        <form action="/" className="mt-10" id="registerForm"
                            ...
                            <p className="italic text-15 text-slate-500 dark:text-zink-200">By registering you agree to the The Hexaa <a href="#!" className="underline">Terms of Use</a></p>
                            <div className="mt-10">
