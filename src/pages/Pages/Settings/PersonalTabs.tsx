                    ...
                    <form action="#!">
                        <div className="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            ...
                            <div className="xl:col-span-12">
                                <label htmlFor="inputValue" className="inline-block mb-2 text-base font-medium">Skill</label>
                                <Select
                            ...
                            <div className="xl:col-span-6">
                                <label htmlFor="inputValue" className="inline-block mb-2 text-base font-medium">Website</label>
                                <input type="text" id="inputValueWebsite" className="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter your value" defaultValue="www.thehexaa.in" />
                            </div>
