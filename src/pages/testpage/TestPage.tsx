        ...
        <React.Fragment>
            ...
            <div className="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                <div className="col-span-12 md:order-1 xl:col-span-8 2xl:col-span-6">
                    <h5 className="mb-2">Welcome The Hexaa 🎉</h5>
                    <p className="mb-5 text-slate-500 dark:text-zink-200">The salary of 
                        <Link to="#" className="underline text-slate-800 dark:text-zink-50"> Glennie Langosh</Link> is pending since 05 Dec, 2023. the documentation of the tasks, workflows, and activities that make up a process managed by the HR or People Ops team. 
