...
//                                         <p className="mb-1 truncate text-slate-500 dark:text-zink-200">Email: <span className="font-semibold">tailwick@thehexaa.com</span></p>
//                                         <p className="mb-1 text-slate-500 dark:text-zink-200">Website: <Link to="//thehexaa.in" target="_blank" rel="noreferrer" className="font-semibold underline text-custom-500">www.thehexaa.in</Link></p>
