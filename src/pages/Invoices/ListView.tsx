...
// // Icons
// import { Search, Trash2, SlidersHorizontal, CalendarClock, FileEdit, Save, MoreHorizontal } from 'lucide-react';
...
//             case "Refund":
//                 return (<span className="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500 dark:bg-slate-500/20 dark:text-zink-200 dark:border-transparent">{item}</span>);
//             default:
...
//                                 </div>
//                                 <button type="button" className="flex items-center justify-center size-[37.5px] p-0 text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 focus:ring focus:ring-sky-100 active:text-white active:bg-sky-600 active:ring active:ring-sky-100 dark:bg-sky-500/20 dark:text-sky-400 dark:hover:bg-sky-500 dark:hover:text-white dark:focus:bg-sky-500 dark:focus:text-white dark:active:bg-sky-500 dark:active:text-white dark:ring-sky-400/20">
//                                     <SlidersHorizontal className="size-4" />
//                                 </button>
//                             </div>
//                         </div>
//                         <SimpleBar className="h-[calc(100vh_-_theme('height.14')_-_theme('spacing.5')_-_theme('height.header')_*_3.5)]">
//                             {(data || []).map((item: any, key: number) => (<Link to="#!" className={`block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600 ${key === 0 && "active"}`} key={key}>
...
//                                         <p className="text-slate-500 dark:text-zink-200">{item.amount}</p>
//                                     </div>
//                                     <p className="self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0"><CalendarClock className="inline-block size-4 ltr:mr-1 rtl:ml-1" /> <span className="align-middle">{item.date}</span></p>
//                                 </div>
//                             </Link>))}
//                         </SimpleBar>
//                     </div>
...
//                                         <li className="text-slate-500 dark:text-zink-200">Create: 10 July, 2023</li>
//                                         <li className="text-slate-500 dark:text-zink-200">Due: 10 July, 2023</li>
//                                     </ul>
//                                 </div>
...
//                                         </div>
//                                         <h5 className="mt-4 mb-1">The Hexaa</h5>
...
//                                         <p className="mb-1 truncate text-slate-500 dark:text-zink-200">Email: <span className="font-semibold">abdul.wahab@thehexaa.com</span></p>
//                                         <p className="mb-1 text-slate-500 dark:text-zink-200">Website: <Link to="//thehexaa.com" target="_blank" rel="noreferrer" className="font-semibold underline text-custom-500">www.thehexaa.com</Link></p>
...
//                                                 <th className="px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500">Item Name</th>
//                                                 <th className="px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500">Rate</th>
//                                                 <th className="px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500">Quantity</th>
//                                                 <th className="px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500">Amount</th>
//                                             </tr>
//                                         </thead>
//                                         <tbody>
//                                             <tr>
...
//                                                     <h6 className="mb-1">Webadmin - Premium Admin & Dashboard</h6>
...
//                                     <p className="mb-0 text-slate-500 dark:text-zink-200">Total Amount: $755.96</p>
//                                 </div>
...
//                                     <span className="font-bold">NOTES:</span> All accounts are to be paid within 7 days from receipt of invoice. To be paid by cheque or credit card or direct payment online. If account is not paid within 7 days the credits details supplied as confirmation of work undertaken will be charged the agreed quoted fee noted above.
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
