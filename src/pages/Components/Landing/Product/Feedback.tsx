                    ...
                    <Swiper className="pb-6 feedback-slider"
                        ...
                        <SwiperSlide>
                            <div className="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                                ...
                                <p className="mt-6 text-16">" thehexaa used Anydesk to fix the bug in Flask and django version. I highly recommend this product! "</p>
                    ...
                    <div className="grid items-center grid-cols-1 gap-5 lg:grid-cols-12">
                        ...
                        <div className="ltr:lg:text-right rtl:lg:text-left lg:col-span-4">
                            <form action="#!" className="relative" data-aos="fade-left">
                                <input type="email" id="subscribeInput" className="py-3 ltr:pr-40 rtl:pl-40 bg-slate-100 dark:bg-zinc-800/40 form-input text-slate-200 border-slate-200 dark:border-zinc-800 focus:outline-none focus:border-custom-500 dark:focus:border-custom-500 placeholder:text-slate-500 dark:placeholder:text-zinc-400 backdrop-blur-md" autoComplete="off" placeholder="tailwick@thehexaa.com" required />
