...
const UpcomingInterviewData = [
    ...
    },
    {
        id: 2,
        name: "Michael Scott",
        email: "michaelScott@thehexaa.com",
        image: User2,
        date: "05 Dec",
        time: "01:23 PM",
        status: "Re-scheduled"
