...
// Product - GridView
const ProductGridViewData = [
    { id: 1, productName: "Mesh Ergonomic Black Chair", img: productImg2, price: "$674.12", delPrice: "784.99", rating: "4.5", ratingNumber: "198", isFav: true },
...
// Sellers
const SellersData = [
    { id: 1, isFav: false, logo: adwords, companyName: "thehexaa", name: "Paula Keenan", sales: "4.5k", products: "310", revenue: "$235.3k" },
...
export { ListViewData, OrderListData, SellersData, ProductGridViewData, ShoppingCartData, ProductReviewsData };